...
export default function Home() {
  ...
  return (
    <div className="flex justify-center">
      <div className="grid grid-cols-[repeat(4,minmax(220px,280px))] gap-x-4 gap-y-6 mx-8 max-sm:grid-cols-[repeat(1,minmax(220px,280px))] max-md:grid-cols-[repeat(2,minmax(220px,280px))] max-lg:grid-cols-[repeat(3,minmax(220px,280px))]">
        {
          loading 
            ? products.map((_, index) => <ProductCardSkeleton />) 
